...
import { Table, TableBody, TableCell, TableHead, TableRow, Checkbox, Button, Typography, Avatar, Box } from '@mui/material';
          ...
          {Math.ceil(companies.length / companiesPerPage) > 1 && (
            <div>
              ...
              <Button
                variant="contained"
                color="primary"
                onClick={() => handlePageChange(Math.ceil(companies.length / companiesPerPage))}
              >
                100
              </Button>
              <Button
